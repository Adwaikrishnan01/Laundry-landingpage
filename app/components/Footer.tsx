    ...
    <footer className="bg-teal-800 text-white py-12">
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-sm text-gray-400">
              We are dedicated to making your laundry experience easier and more convenient.
            </p>
          </div>
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-sm text-gray-400 hover:underline">Services</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              <li>Email: support@laundryapp.com</li>
              <li>Phone: +1 (234) 567-890</li>
              <li>Address: 123 Laundry Street, Clean City</li>
            </ul>
          </div>
          <div>
        ...
        <div className="mt-8 text-center text-gray-400 text-sm">
          &copy; {new Date().getFullYear()} Laundry App. All rights reserved.
        </div>
      </motion.div>
    </footer>
  );
